...
# class GetAnsweredQuestionsSerializer(serializers.ModelSerializer):
#     class Meta:
#         model = Question
#         fields = [
#             'id',
...
# class GetaAnsweredCategoryWithQuestionsSerializer(serializers.ModelSerializer):
#     questions = serializers.SerializerMethodField()
...
#         return GetAnsweredQuestionsSerializer(questions, many=True).data
