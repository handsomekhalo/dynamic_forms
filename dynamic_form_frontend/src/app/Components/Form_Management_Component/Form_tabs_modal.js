  ...
  export function EnhancedFormList({ forms, activeTab, onAssignClick, onAssignQuestionsClick, onUpdateClick }) {
...
<button
  onClick={() => onUpdateClick(form)} // <-- use prop passed from parent
