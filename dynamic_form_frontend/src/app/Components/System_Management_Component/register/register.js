...
// const RegisterPage = () => {
//   const { login: authLogin, navigateTo } = useAuth(); // Get navigateTo from useAuth
...
//           navigateTo('/dashboard'); // Use navigateTo instead of navigate
//         } else {
...
//       }
//     } catch (err) {
//       setErrors((prev) => ({ ...prev, server: err.response?.data?.message || 'An error occurred. Please try again.' }));
//     } finally {
//       setIsSubmitting(false);
//     }
//   };
